...
/**
 * Created by joannegaeunson on 2/22/17.
 */
import edu.ucsd.cse110.temperature.Farenheit;
import edu.ucsd.cse110.temperature.Temperature;
import junit.framework.TestCase;

public class FarenheitTest extends TestCase{
    private float delta = 0.001f;

    public void testFarenheit(){
        float value = 12.34f;
        Farenheit temp = new Farenheit(value);

        assertEquals(value, temp.getValue(), delta);
    }

    public void testFarenheitToString(){
        float value = 12.34f;
    ...
    {
        Farenheit temp = new Farenheit(32);
