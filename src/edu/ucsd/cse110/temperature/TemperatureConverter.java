...
public class TemperatureConverter {
    public static void main(String args[]) throws IOException
    {
        ...
        while(true)
        {
            ...
            System.out.print("Enter edu.ucsd.cse110.temperature to convert (i.e. 36.8 C, 451 F): ");
            ...
            switch(temp_in[1].toLowerCase().charAt(0))
            {
                case 'c':
                    ...
                    break;
                case 'f':
                    inputTemp = new Farenheit(temp_val);
                    break;
                default:
            ...
            System.out.println("\n The converted edu.ucsd.cse110.temperature is " + outputTemp.toString() +"\n\n");
        }
    }
}
